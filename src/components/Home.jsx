  ...
  return (
    <div>
      ...
      <section className="mt-5 p-4">
        ...
        <Carousel>
          <Carousel.Item>
            <img className="d-block w-100" src="https://via.placeholder.com/800x400" alt="Campaign 1" />
            <Carousel.Caption>
              <h3>Save the Environment</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img className="d-block w-100" src="https://via.placeholder.com/800x400" alt="Campaign 2" />
            <Carousel.Caption>
